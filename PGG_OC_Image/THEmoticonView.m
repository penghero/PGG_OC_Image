...
- (instancetype)initWithImage:(UIImage *)image{
    ...
    if (self) {
        ...
        _deleteButton.frame = CGRectMake(0, 0, kDeleteBtnSize, kDeleteBtnSize);
...
//        [self addSubview:_deleteButton];
        ...
        _scaleBtn = [[THScaleButton alloc] initWithFrame:CGRectMake(0, 0, kDeleteBtnSize, kDeleteBtnSize)];
...
- (void)setAvtive:(BOOL)active
{
    ...
    _imageView.layer.borderWidth = (active) ? 5/_scale : 0;
...
- (void)setScale:(CGFloat)scale
{
    ...
    rct.origin.x += (rct.size.width - (_imageView.width + kDeleteBtnSize)) / 2;
    rct.origin.y += (rct.size.height - (_imageView.height + kDeleteBtnSize)) / 2;
    rct.size.width  = _imageView.width + kDeleteBtnSize;
    rct.size.height = _imageView.height + kDeleteBtnSize;
    self.frame = rct;
    ...
    _imageView.layer.borderWidth = 5/_scale;
